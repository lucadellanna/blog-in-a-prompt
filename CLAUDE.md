...
|-------|---------|-----------------|
| `/review-readme` | Review README.md for accuracy and non-technical clarity | "review the readme", "check the readme", "audit README.md" |
| `/review-prompt` | Review PROMPT.md for correctness and executability | "review the prompt", "check the prompt", "audit PROMPT.md" |
